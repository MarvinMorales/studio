      ...
      <main className="flex-1 pt-20">
        <div className="container mx-auto px-4 md:px-6 py-12 md:py-20">
          <article className="prose lg:prose-xl max-w-none text-foreground">
            <h1 className="text-4xl font-headline font-bold text-primary mb-8">Términos y Condiciones de Uso</h1>

            <section className="mb-8">
                <h2 className="text-2xl font-headline font-semibold text-primary mb-4">1. INFORMACIÓN RELEVANTE</h2>
            ...
            <section className="mb-8">
                <h2 className="text-2xl font-headline font-semibold text-primary mb-4">2. LICENCIA</h2>
                <p>Retail Point a través de su sitio web concede una licencia para que los usuarios utilicen los productos que son vendidos en este sitio web de acuerdo a los Términos y Condiciones que se describen en este documento.</p>
            </section>
            
            <section className="mb-8">
                <h2 className="text-2xl font-headline font-semibold text-primary mb-4">3. USO NO AUTORIZADO</h2>
            ...
            <section className="mb-8">
                <h2 className="text-2xl font-headline font-semibold text-primary mb-4">4. PROPIEDAD</h2>
            ...
            <section className="mb-8">
                <h2 className="text-2xl font-headline font-semibold text-primary mb-4">5. POLÍTICA DE REEMBOLSO Y GARANTÍA</h2>
            ...
            <section className="mb-8">
                <h2 className="text-2xl font-headline font-semibold text-primary mb-4">6. COMPROBACIÓN ANTIFRAUDE</h2>
            ...
            <section>
                ...
                <p>Retail Point reserva los derechos de cambiar o de modificar estos términos sin previo aviso.</p>
            </section>
